...
class BinanceAPI(object):
    ...
    def get_continuousKlines(self):
        # path = "%s/fapi/v1/continuousKlines" % self.BASE_URL
        path = 'https://fapi.binance.com/fapi/v1/continuousKlines'
        params = {"pair": 'BTCUSDT', 'interval': '1m',
...
if __name__ == "__main__":
    ...
    print(instance.get_continuousKlines())
